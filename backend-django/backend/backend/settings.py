...
EMAIL_HOST = 'smtp.gmail.com'  # หรือ SMTP Server ที่คุณใช้
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'testsmarthwithyou01@gmail.com'  # อีเมลที่ใช้ส่ง
EMAIL_HOST_PASSWORD = 'jzuj dsbq kipk xzaa'  # รหัสผ่านของอีเมล